...
namespace Azureservices.Security
{
    public static class UserToken
    {
        [FunctionName("UserToken")]
        public static HttpResponseMessage Run([HttpTrigger(AuthorizationLevel.Function, "post")]Input input, [Blob("{ContainerName}", FileAccess.Read, Connection = "")]CloudBlobDirectory blobDirectory, TraceWriter log)
        {
