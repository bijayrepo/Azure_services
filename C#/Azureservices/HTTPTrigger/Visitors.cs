...
namespace Azureservices.HTTPTrigger
{
    public static class Visitors
    {
        ...
        public static HttpResponseMessage Run([HttpTrigger(AuthorizationLevel.Admin, "put")]Person person, [Table("Visitor", Connection = "")]CloudTable outTable, TraceWriter log)
        {
